...
function VXLiveRoom({ onExit }) {
  ...
  return (
    <div className={`vxLive vxMood-${presence.mood} rabbit-${presence.rabbitLevel}`} style={{ "--energy": `${presence.energy}%` }}>
      ...
      <div className="vxLiveStage">
        ...
        <div className="vxSidePanel">
          ...
          <div className="vxLiveNote">
            ...
            <b>{presence.rabbitLevel} / {presence.speaking ? "voice reactive" : "listening"}</b>
          </div>
        </div>
      </div>
